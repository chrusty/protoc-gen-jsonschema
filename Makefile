...
fmt:
	@gofmt -s -w .
	@goimports -w -local github.com/AppliedIntuition/protoc-gen-jsonschema .
...
.PHONY: install
install:
	@go install github.com/AppliedIntuition/protoc-gen-jsonschema/cmd/protoc-gen-jsonschema
