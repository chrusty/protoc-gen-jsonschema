...
samples:
	...
	@PATH=./bin:$$PATH; protoc --jsonschema_out=enforce_oneof,all_fields_required:jsonschemas --proto_path=${PROTO_PATH} ${PROTO_PATH}/OneOf.proto || echo "No messages found (OneOf.proto)"
