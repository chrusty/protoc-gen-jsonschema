...
type FieldOptions struct {
	...
	// Fields tagged with this will be constrain strings using the "minLength" keyword in generated schemas
	MinLength int32 `protobuf:"varint,3,opt,name=min_length,json=minLength,proto3" json:"min_length,omitempty"`
	// Fields tagged with this will be constrain strings using the "maxLength" keyword in generated schemas
	MaxLength int32 `protobuf:"varint,4,opt,name=max_length,json=maxLength,proto3" json:"max_length,omitempty"`
	// Fields tagged with this will be constrain strings using the "pattern" keyword in generated schemas
...
var file_options_proto_rawDesc = []byte{
	...
	0x73, 0x4f, 0x6e, 0x6c, 0x79, 0x3a, 0x68, 0x0a, 0x0d, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x5f, 0x6f,
